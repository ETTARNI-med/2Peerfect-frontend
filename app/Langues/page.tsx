        ...
        <div className="grid grid-cols-3 place-items-center">
          {datas.map((data) => (
            <div className="w-[401px] h-[416px] relative mb-16">
              ...
              <Image
                className="w-[186px] h-[191px] left-[112px] top-[92px] absolute"
                src={data.logo}
                alt=""
                priority
              />
              <div className="left-[148px] top-[350px] absolute text-blue-800 text-2xl font-semibold  capitalize">
                <Link href={data.link}>{data.langue}</Link>
              </div>
            </div>
          ))}
        </div>
