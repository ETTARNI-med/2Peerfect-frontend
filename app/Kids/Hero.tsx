        ...
        <div className="w-full bg-blue-700 h-[25rem] mt-20 p-4 flex items-center gap-16 justify-center">
            <div className=" flex flex-col justify-center gap-6 w-[39rem]">
                ...
                <p className="text-white text-xl leading-relaxed">
                    ...
                    dans l'univers de l'apprentissage et de la découverte. C'est
                    un engagement à s'immerger complètement dans les
                    connaissances, les compétences et les expériences offertes
                    par notre programme.
                </p>
