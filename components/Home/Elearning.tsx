      ...
      <div className=" top-16 left-8">
        ...
        <div className="relative -top-[280px] left-11">
          ...
          <div className="w-[447.84px] h-[262.98px] text-blue-800 text-2xl font-light">
            ...
            e-le arning vous permet un apprentissage plus individualisé, avec
            des modules adaptés au rythme et au style d'apprentissage de chacun.
          </div>
        </div>
        <div className="absolute top-52 -left-[85px]">
        <div className="absolute font-extrabold -z-10 w-[111px] h-[70px] rounded-full shadow border-[10px] border-black  " />
        </div>
        {/* <Image
